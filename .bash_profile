...
export PATH=$HOME/.linuxbrew/bin:$HOME/.linuxbrew/opt/python/libexec/bin:$PATH
...
alias loginaws='chmod 400 ~/Documents/ssh_keys/me.neemiasvf.aws.pem && ssh -i ~/Documents/ssh_keys/me.neemiasvf.aws.pem neemiasvf@aws.neemiasvf.me'
alias logindstaws='chmod 400 ~/Documents/ssh_keys/me.neemiasvf.aws.dst.pem && ssh -i ~/Documents/ssh_keys/me.neemiasvf.aws.dst.pem neemiasvf@54.94.134.24'
